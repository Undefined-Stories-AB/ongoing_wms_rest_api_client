...
from ...models.get_article_items_model import GetArticleItemsModel
...
def _get_kwargs(
    *,
    ...
    location_names: Union[Unset, None, List[str]] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v1/articleItems".format(client.base_url)
    ...
    json_location_names: Union[Unset, None, List[str]] = UNSET
    if not isinstance(location_names, Unset):
        if location_names is None:
            json_location_names = None
        else:
            json_location_names = location_names

    params["locationNames"] = json_location_names
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Optional[List["GetArticleItemsModel"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200 or []:
            response_200_item = GetArticleItemsModel.from_dict(response_200_item_data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Optional[List["GetArticleItemsModel"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    article_numbers: Union[Unset, None, List[str]] = UNSET,
    location_names: Union[Unset, None, List[str]] = UNSET,
) -> Response[Optional[List["GetArticleItemsModel"]]]:
    ...
    Args:
        ...
        location_names (Union[Unset, None, List[str]]):
...
def sync(
    *,
    ...
    article_numbers: Union[Unset, None, List[str]] = UNSET,
    location_names: Union[Unset, None, List[str]] = UNSET,
) -> Optional[Optional[List["GetArticleItemsModel"]]]:
    """Get all article items which match the specified search criteria.
    ...
    Returns:
        Optional[List['GetArticleItemsModel']]
    """
