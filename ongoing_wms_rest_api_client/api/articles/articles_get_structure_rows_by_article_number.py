...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/articles/structureDefinitions".format(client.base_url)
    ...
    params["articleKind"] = article_kind
...
) -> Optional[List["GetArticleStructureDefinitionModel"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = GetArticleStructureDefinitionModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[List["GetArticleStructureDefinitionModel"]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        List['GetArticleStructureDefinitionModel']
    """
