...
from ...models.patch_order_delivery_date import PatchOrderDeliveryDate
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: Optional[PatchOrderDeliveryDate],
) -> Dict[str, Any]:
    url = "{}/api/v1/orders/{orderId}/deliveryDate".format(client.base_url, orderId=order_id)
