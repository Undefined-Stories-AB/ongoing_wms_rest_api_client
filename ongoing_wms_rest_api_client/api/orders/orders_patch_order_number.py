...
from ...models.patch_order_number_model import PatchOrderNumberModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchOrderNumberModel,
) -> Dict[str, Any]:
    url = "{}/api/v1/orders/{orderId}/orderNumber".format(client.base_url, orderId=order_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Update the order number of an existing order. Note that the system will not verify that the order
    number is unique.
