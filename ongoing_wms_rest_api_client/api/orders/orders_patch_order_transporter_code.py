...
from ...models.patch_order_transporter_model import PatchOrderTransporterModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchOrderTransporterModel,
) -> Dict[str, Any]:
    url = "{}/api/v1/orders/{orderId}/transporter".format(client.base_url, orderId=order_id)
