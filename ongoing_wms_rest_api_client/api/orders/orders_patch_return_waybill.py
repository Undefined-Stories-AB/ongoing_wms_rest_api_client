...
from ...models.patch_order_return_waybill import PatchOrderReturnWaybill
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchOrderReturnWaybill,
) -> Dict[str, Any]:
    url = "{}/api/v1/orders/{orderId}/returnWaybill".format(client.base_url, orderId=order_id)
