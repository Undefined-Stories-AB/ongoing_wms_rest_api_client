...
from ...models.patch_order_classes_model import PatchOrderClassesModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchOrderClassesModel,
) -> Dict[str, Any]:
    url = "{}/api/v1/orders/{orderId}/setOrderClasses".format(client.base_url, orderId=order_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Set order classes on an existing order. If the order has any other classes which you don't send,
    they will be deleted from the order.
