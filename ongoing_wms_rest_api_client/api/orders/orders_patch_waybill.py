...
from ...models.patch_order_waybill import PatchOrderWaybill
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchOrderWaybill,
) -> Dict[str, Any]:
    url = "{}/api/v1/orders/{orderId}/waybill".format(client.base_url, orderId=order_id)
