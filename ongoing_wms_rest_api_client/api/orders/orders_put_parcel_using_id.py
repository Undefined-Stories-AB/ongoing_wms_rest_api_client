...
from ...models.post_parcel_using_id_type_model import PostParcelUsingIdTypeModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PostParcelUsingIdTypeModel,
) -> Dict[str, Any]:
    url = "{}/api/v1/orders/{orderId}/parcels/{parcelId}".format(client.base_url, orderId=order_id, parcelId=parcel_id)
