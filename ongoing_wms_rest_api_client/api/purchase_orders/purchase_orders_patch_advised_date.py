...
from ...models.patch_purchase_order_advised_date import PatchPurchaseOrderAdvisedDate
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchPurchaseOrderAdvisedDate,
) -> Dict[str, Any]:
    url = "{}/api/v1/purchaseOrders/{purchaseOrderId}/advisedDate".format(
