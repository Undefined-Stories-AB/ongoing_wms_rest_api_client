...
from ...models.patch_purchase_order_free_bool_1 import PatchPurchaseOrderFreeBool1
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchPurchaseOrderFreeBool1,
) -> Dict[str, Any]:
    url = "{}/api/v1/purchaseOrders/{purchaseOrderId}/freeBool1".format(
