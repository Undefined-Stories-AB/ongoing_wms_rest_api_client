...
from ...models.patch_purchase_order_status import PatchPurchaseOrderStatus
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchPurchaseOrderStatus,
) -> Dict[str, Any]:
    url = "{}/api/v1/purchaseOrders/{purchaseOrderId}/purchaseOrderStatus".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update the status of a purchase order. Note that if the warehouse has started to recieve goods from
    the purchase order, then it's possible that this call will fail.
