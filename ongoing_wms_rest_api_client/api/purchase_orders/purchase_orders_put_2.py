...
from ...models.post_purchase_order_model import PostPurchaseOrderModel
...
def _get_kwargs(
    *,
    client: Client,
    json_body: PostPurchaseOrderModel,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Create or update a purchase order. If no purchase order with the specified purchase order number
    exists, a new purchase order will be created. Otherwise the existing purchase order will be updated.
