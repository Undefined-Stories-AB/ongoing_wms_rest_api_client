...
T = TypeVar("T", bound="GetArticleAlternativeBarCode")


@attr.s(auto_attribs=True)
class GetArticleAlternativeBarCode:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_article_alternative_bar_code = cls(
            bar_code=bar_code,
            quantity_per_bar_code=quantity_per_bar_code,
            bar_code_type=bar_code_type,
        )

        return get_article_alternative_bar_code
