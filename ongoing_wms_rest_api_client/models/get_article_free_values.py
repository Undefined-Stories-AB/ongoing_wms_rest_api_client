...
T = TypeVar("T", bound="GetArticleFreeValues")


@attr.s(auto_attribs=True)
class GetArticleFreeValues:
    """
    Attributes:
        free_decimal_1 (Union[Unset, None, float]):
        free_decimal_2 (Union[Unset, None, float]):
        free_decimal_3 (Union[Unset, None, float]):
        free_boolean_1 (Union[Unset, bool]):
        free_boolean_2 (Union[Unset, bool]):
        free_boolean_3 (Union[Unset, bool]):
    """
    ...
    free_boolean_1: Union[Unset, bool] = UNSET
    free_boolean_2: Union[Unset, bool] = UNSET
    free_boolean_3: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_article_free_values
