...
T = TypeVar("T", bound="GetArticleProperShippingNameModel")


@attr.s(auto_attribs=True)
class GetArticleProperShippingNameModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_article_proper_shipping_name_model = cls(
            language_code=language_code,
            name=name,
        )

        return get_article_proper_shipping_name_model
