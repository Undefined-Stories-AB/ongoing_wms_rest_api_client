...
T = TypeVar("T", bound="GetPickedArticleItemParentParcelAdvanced")


@attr.s(auto_attribs=True)
class GetPickedArticleItemParentParcelAdvanced:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_picked_article_item_parent_parcel_advanced = cls(
            parcel_serial_number=parcel_serial_number,
        )

        return get_picked_article_item_parent_parcel_advanced
