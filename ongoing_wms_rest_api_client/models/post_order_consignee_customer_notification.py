...
T = TypeVar("T", bound="PostOrderConsigneeCustomerNotification")


@attr.s(auto_attribs=True)
class PostOrderConsigneeCustomerNotification:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_order_consignee_customer_notification = cls(
            to_be_notified=to_be_notified,
            value=value,
        )

        return post_order_consignee_customer_notification
