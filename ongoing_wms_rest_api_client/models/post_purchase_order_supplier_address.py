...
T = TypeVar("T", bound="PostPurchaseOrderSupplierAddress")


@attr.s(auto_attribs=True)
class PostPurchaseOrderSupplierAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_purchase_order_supplier_address = cls(
            name=name,
            address=address,
            address2=address2,
            address3=address3,
        ...
        return post_purchase_order_supplier_address
