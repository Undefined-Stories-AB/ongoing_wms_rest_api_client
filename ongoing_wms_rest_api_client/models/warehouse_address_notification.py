...
T = TypeVar("T", bound="WarehouseAddressNotification")


@attr.s(auto_attribs=True)
class WarehouseAddressNotification:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        warehouse_address_notification = cls(
            to_be_notified=to_be_notified,
            value=value,
        )

        return warehouse_address_notification
